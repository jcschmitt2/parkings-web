...
<head>
  ...
  <style>
    ...
    * {{ box-sizing:border-box; }}
    ...
    a.hub-brand:hover {{ color:#fff; text-decoration:none; }}
    a.hub-brand:focus-visible {{
      outline:2px solid #7dd3fc;
      outline-offset:3px;
      border-radius:8px;
    }}
    .hub-brand-logo {{ width:32px; height:32px; flex-shrink:0; }}
...
<body>
  <header class="hub-header">
    <div class="hub-top">
      ...
      <a class="hub-brand" href="/" aria-label="ParkEco — accueil">
        <svg class="hub-brand-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true">
          <defs>
            <linearGradient id="hub-pk-lavender" x1="18%" y1="12%" x2="88%" y2="92%">
              <stop offset="0%" stop-color="#c7d2fe"/>
              <stop offset="55%" stop-color="#a7b4ff"/>
              <stop offset="100%" stop-color="#7c89e8"/>
            </linearGradient>
          </defs>
          <circle cx="16" cy="16" r="13" fill="url(#hub-pk-lavender)" stroke="#ffffff" stroke-width="2"/>
          <text x="16" y="21.5" text-anchor="middle" fill="#ffffff" font-family="system-ui,-apple-system,Segoe UI,Roboto,sans-serif" font-size="15" font-weight="800">P</text>
        </svg>
